...
.nav-links a{font-size:14px;font-weight:500;color:var(--g500);transition:var(--t)}
.nav-links a:hover{color:var(--blue)}
.nav-actions{display:flex;gap:10px;align-items:center}
.btn-o{padding:8px 20px;font-size:14px;font-weight:600;color:var(--blue);border:2px solid var(--blue);border-radius:8px;transition:var(--t);background:transparent;cursor:pointer}
...
.btn-g{padding:12px 24px;font-size:14px;font-weight:600;color:#444;background:#fff;border:1px solid #ddd;border-radius:8px;transition:var(--t);cursor:pointer;display:flex;align-items:center;justify-content:center;gap:10px;width:100%}
.btn-g:hover{background:#f8f8f8;border-color:#ccc}
.lang-wrap{position:relative}
.lang-btn{display:flex;align-items:center;gap:6px;padding:7px 14px;background:rgba(0,102,255,.08);border:1px solid rgba(0,102,255,.15);border-radius:8px;font-size:13px;font-weight:600;color:var(--blue);cursor:pointer}
...
.lang-opt{display:flex;align-items:center;gap:10px;padding:12px 16px;font-size:14px;font-weight:500;cursor:pointer}
...
.m-btn span{width:100%;height:2px;background:var(--dark);border-radius:2px}
...
.hero-badge{display:inline-flex;align-items:center;gap:8px;padding:8px 16px;background:rgba(0,102,255,.08);border:1px solid rgba(0,102,255,.2);border-radius:24px;font-size:13px;font-weight:600;color:var(--blue);margin-bottom:24px}
.hero-title{font-size:clamp(32px,5vw,52px);font-weight:800;line-height:1.15;margin-bottom:24px}
...
.hero-desc{font-size:16px;color:var(--g500);margin-bottom:32px;line-height:1.8;max-width:520px}
...
.stat-num{font-size:30px;font-weight:800;background:linear-gradient(135deg,var(--blue),var(--cyan));-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
.stat-label{font-size:13px;color:var(--g400);font-weight:500}
.country-reg{margin-top:32px}
...
.country-select{width:100%;padding:14px 48px 14px 16px;border:2px solid rgba(0,102,255,.25);border-radius:var(--r);font-size:14px;font-weight:600;color:var(--dark);background:#fff;cursor:pointer;appearance:none;-webkit-appearance:none}
...
.globe-wrap{position:relative;width:380px;height:380px}
.globe-ring{position:absolute;border:1px solid rgba(0,102,255,.12);border-radius:50%;animation:gr 22s linear infinite}
.ring1{width:280px;height:280px;top:50px;left:50px;animation-duration:26s}
.ring2{width:180px;height:180px;top:100px;left:100px;animation-duration:18s;animation-direction:reverse}
.ring3{width:80px;height:80px;top:150px;left:150px;animation-duration:12s}
@keyframes gr{from{transform:rotate(0)}to{transform:rotate(360deg)}}
.globe-core{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:180px;height:180px;color:var(--blue)}
.globe-svg{width:100%;height:100%}
.fc{position:absolute;background:#fff;padding:12px 16px;border-radius:14px;box-shadow:var(--shadow);display:flex;align-items:center;gap:8px;font-size:13px;font-weight:600;color:var(--dark);white-space:nowrap}
.fc1{top:30px;left:0}
.fc2{top:50%;right:0;transform:translateY(-50%)}
.fc3{bottom:30px;left:50%;transform:translateX(-50%)}
...
.modal{background:#fff;border-radius:24px;padding:48px;max-width:520px;width:92%;text-align:center;box-shadow:0 24px 80px rgba(0,0,0,.2);position:relative}
.modal-close{position:absolute;top:16px;right:16px;width:36px;height:36px;border-radius:50%;background:var(--g100);border:none;cursor:pointer;font-size:18px;display:flex;align-items:center;justify-content:center}
...
.btn-later{display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:var(--g100);color:var(--g500);border-radius:10px;font-weight:600;font-size:15px;border:none;cursor:pointer}
...
.support-panel{display:none;position:absolute;bottom:75px;right:0;width:300px;background:#fff;border-radius:16px;box-shadow:0 10px 40px rgba(0,0,0,.15);overflow:hidden}
...
.auth-page{min-height:100vh;display:flex;align-items:center;justify-content:center;padding:24px;background:linear-gradient(135deg,rgba(0,102,255,.05) 0%,rgba(0,212,255,.05) 100%)}
.auth-card{background:#fff;border-radius:var(--r2);padding:48px;max-width:480px;width:100%;box-shadow:var(--shadow2)}
.auth-header{text-align:center;margin-bottom:32px}
.auth-header h1{font-size:28px;font-weight:800;color:var(--dark);margin-bottom:8px}
.auth-header p{font-size:14px;color:var(--g500)}
.auth-form{display:flex;flex-direction:column;gap:16px}
.phone-group{display:flex;gap:12px}
.phone-prefix{flex:0 0 140px}
.phone-input{flex:1}
.code-group{display:flex;gap:12px}
.code-input{flex:1}
.code-btn{flex:0 0 120px;padding:12px 16px;background:var(--g100);border:1px solid var(--g200);border-radius:8px;font-size:13px;font-weight:600;color:var(--blue);cursor:pointer;transition:var(--t)}
.code-btn:hover:not(:disabled){background:var(--blue);color:#fff;border-color:var(--blue)}
.code-btn:disabled{opacity:.6;cursor:not-allowed}
.divider{display:flex;align-items:center;gap:16px;margin:24px 0;color:var(--g400);font-size:14px}
...
print('CSS generated:', len(CSS), 'chars')

# Write CSS to file for reference
