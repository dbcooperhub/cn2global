#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""CN2Global - Generate complete HTML pages"""
...
def write(name, content):
    ...
    print(f'[OK] {name} ({size//1024}KB, {size} bytes)')
...
.fc2{top:50%;right:0;animation-delay:1.5s}
...
.support-footer{padding:14px 20px;background:var(--g100);border-top:1px solid var(--